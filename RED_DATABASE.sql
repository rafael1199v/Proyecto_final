...
CREATE TABLE TEMAS_PUBLICACION (
    ID NUMBER(8) NOT NULL PRIMARY KEY,
    ID_PUBLICACION NUMBER(8) NOT NULL,
    ID_TEMA NUMBER(8) NOT NULL
);

create sequence TEMAS_PUBLICACION_SEQ increment by 1;
...
ALTER TABLE TEMAS_PUBLICACION
ADD CONSTRAINT "FK_PUBLICACION_TO_TEMAS_PUBLICACION" 
FOREIGN KEY ("ID_PUBLICACION")
REFERENCES PUBLICACION ("ID") ENABLE;

ALTER TABLE TEMAS_PUBLICACION
ADD CONSTRAINT "FK_TEMAS_TO_TEMAS_PUBLICACION" 
FOREIGN KEY ("ID_TEMA")
...
ALTER TABLE HASHTAG_PUBLICACION
ADD CONSTRAINT "FK_TEMAS_TO_HASHTAG_PUBLICACION" 
